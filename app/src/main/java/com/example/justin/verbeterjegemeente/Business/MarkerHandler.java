...
public class MarkerHandler {
    ...
    private ArrayList<ServiceRequest> requestList;
    ...
    //constructor
    public MarkerHandler(GoogleMap map, Context context) {
    ...
    public void setVisible(int category) {
        ...
        for (Marker m : deOpperArrayList.get(category)) {
            m.setVisible(true);
        }
    }
                    ...
                    public void onResponse(Call<ArrayList<ServiceRequest>> call, Response<ArrayList<ServiceRequest>> response) {
                        if(response.isSuccessful()) {
                            ...
                            for (ServiceRequest sr : requestList) {
                                int i = 0;
                                Marker marker = mMap.addMarker(new MarkerOptions().position(new LatLng(sr.getLat(), sr.getLong())).title(sr.getDescription())
